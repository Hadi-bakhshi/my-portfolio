...
export const receptionAssistantEtl: CaseStudyDetail = {
  ...
  diagram: {
    ...
    nodes: [
      { id: "cati", label: "CATI", sub: "Survey completes", x: 50, y: 140 },
      { id: "outbox1", label: "Outbox", sub: "Publish event", x: 170, y: 140 },
      { id: "mq", label: "Topic Exchange", sub: "RabbitMQ", x: 300, y: 140 },
      { id: "altmq", label: "Alternate Exchange", sub: "Unrouted messages", x: 300, y: 40 },
      { id: "followup", label: "Follow-Up ETL", sub: "Independent consumer", x: 430, y: 60 },
      { id: "inbox", label: "Inbox", sub: "Idempotency", x: 430, y: 140 },
      { id: "dlq", label: "Poison Queue", sub: "Dead-lettered after retries", x: 430, y: 240 },
      { id: "mapping", label: "Mapping Engine", sub: "Transform", x: 570, y: 140 },
      { id: "outbox2", label: "Outbox", sub: "Publish result", x: 570, y: 220 },
      { id: "ra", label: "Reception Assistant", sub: "Customer history + prediction", x: 700, y: 180 },
    ],
    edges: [
